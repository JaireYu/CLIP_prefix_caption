...
method_id=BASE_LINE_only_prefix_beam_search_wo_prefix_norm # not using beam search
...
--out_dir $output_dir --mapping_type transformer --num_layers 8 --prefix_length 40 --prefix_length_clip 40 --beam_search > $output_dir/nohup.out &
